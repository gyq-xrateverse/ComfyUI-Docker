...
REPOS=(
    ...
    "https://github.com/MinusZoneAI/ComfyUI-MingNodes.git"
    "https://github.com/kijai/ComfyUI-FluxTrainer.git"
    "https://github.com/kealiu/comfyui-supir.git"
    "https://github.com/kijai/ComfyUI-3D-Pack.git"
    "https://github.com/AlexanderDzhoganov/comfyui-dream-video-batches.git"
    "https://github.com/Phando/ComfyUI-nunchaku.git"
